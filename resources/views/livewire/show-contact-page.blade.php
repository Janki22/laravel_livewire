                                  ...
                                  <div class="contact-form">
                                      <form wire:submit="submit">
                                          <div class="form-group mb-4 pb-2">
                                              ...
                                              <input type="text" class="form-control shadow-none @error('name') is-invalid @enderror" wire:model="name" name="name" id="name">
                                              @error('name')
                                          ...
                                          <div class="form-group mb-4 pb-2">
                                              <label for="messgae" class="form-label">Write Message</label>
                                              <textarea class="form-control shadow-none" id="mssage" wire:model="message" name="message" rows="3"></textarea>
                                          </div>
